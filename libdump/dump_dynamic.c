...
if (get_dump_status(sim,dump_dynamic)==TRUE)
{
	...
	buffer_dump_path(out_dir,"dynamic_jp_drift_plus_diffusion.dat",&buf);
	buffer_free(&buf);
	...
	buffer_dump_path(out_dir,"dynamic_jn_drift_plus_diffusion.dat",&buf);
	buffer_free(&buf);
	...
	strcpy(buf.type,"xy");
	strcpy(buf.x_label,_("Time"));
	strcpy(buf.y_label,_("Recombination"));
	strcpy(buf.x_units,"\\mu s");
	strcpy(buf.y_units,"m^{-3}s^{-1}");
	buf.logscale_x=0;
	buf.logscale_y=0;
	...
	strcpy(buf.type,"xy");
	strcpy(buf.x_label,_("Time"));
	strcpy(buf.y_label,_("Free electron loss"));
	strcpy(buf.x_units,"\\mu s");
	strcpy(buf.y_units,"m^{-3}s^{-1}");
	buf.logscale_x=0;
	buf.logscale_y=0;
	...
	strcpy(buf.type,"xy");
	strcpy(buf.x_label,_("Time"));
	strcpy(buf.y_label,_("Free hole loss"));
	strcpy(buf.x_units,"\\mu s");
	strcpy(buf.y_units,"m^{-3}s^{-1}");
	buf.logscale_x=0;
	buf.logscale_y=0;
	...
	strcpy(buf.type,"xy");
	strcpy(buf.x_label,_("Time"));
	strcpy(buf.y_label,_("Relaxation"));
	strcpy(buf.x_units,"\\mu s");
	strcpy(buf.y_units,"m^{-3}s^{-1}");
	buf.logscale_x=0;
	buf.logscale_y=0;
	...
	strcpy(buf.type,"xy");
	strcpy(buf.x_label,_("Time"));
	strcpy(buf.y_label,_("PL Intensity"));
	strcpy(buf.x_units,"s");
	...
	strcpy(buf.type,"xy");
	strcpy(buf.x_label,_("Time"));
	strcpy(buf.y_label,_("band bend"));
	strcpy(buf.x_units,"s");
	strcpy(buf.y_units,_("percent"));
	buf.logscale_x=1;
	buf.logscale_y=1;
	buffer_add_info(&buf);
