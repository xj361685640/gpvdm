...
class my_data():
	...
	units=""
	info=""
	def __init__(self,a,b,c,e,f,widget,defaults=None):
		self.token=a
		self.units=b
		self.info=c
...
lib.append(my_data("#solver_name",_("dll name"),_("Matrix solver to use"),"e",1.0,"QLineEdit"))
lib.append(my_data("#newton_name",_("dll name"),_("Newton solver to use"),"e",1.0,"QLineEdit"))
...
lib.append(my_data("#dump_band_structure","","","e",1.0,"QLineEdit"))
lib.append(my_data("#dump_slices_by_time",_("True/False"),_("dump slices by time"),"e",1.0,"gtkswitch"))
lib.append(my_data("#dump_1d_slices",_("True/False"),_("Dump 1D slices"),"e",1.0,"gtkswitch"))
...
lib.append(my_data("#dump_iodump","","","e",1.0,"QLineEdit"))
lib.append(my_data("#dump_movie","","","e",1.0,"QLineEdit"))
lib.append(my_data("#dump_optics",_("True/False"),_("Dump optical information"),"e",1.0,"gtkswitch"))
lib.append(my_data("#dump_optics_verbose","","","e",1.0,"QLineEdit"))
lib.append(my_data("#dump_print_newtonerror",_("True/False"),_("Print newton error"),"e",1.0,"gtkswitch"))
lib.append(my_data("#dump_print_converge",_("True/False"),_("Print solver convergence"),"e",1.0,"gtkswitch"))
...
lib.append(my_data("#dump_pl",_("True/False"),_("Dump PL spectra"),"e",1.0,"gtkswitch"))
...
lib.append(my_data("#dumpitdos","","","e",1.0,"QLineEdit"))
lib.append(my_data("#dump_workbook",_("True/False"),_("Dump an excel workbook for each simulation run congaing the results."),"e",1.0,"gtkswitch"))
...
lib.append(my_data("#Rshunt","Ohms",_("Shunt resistance"),"e",1.0,"QLineEdit"))
lib.append(my_data("#Rcontact","Ohms",_("Series resistance"),"e",1.0,"QLineEdit"))
