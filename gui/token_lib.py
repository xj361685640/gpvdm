...
lib.append(my_data("#voc_nt","m^{-3}",_("Trapped electrons at Voc"),["text"],"e",1.0))
lib.append(my_data("#voc_pt","m^{-3}",_("Trapped holes at Voc"),["text"],"e",1.0))
lib.append(my_data("#voc_nf","m^{-3}",_("Free electrons at Voc"),["text"],"e",1.0))
lib.append(my_data("#voc_pf","m^{-3}",_("Free holes at Voc"),["text"],"e",1.0))
lib.append(my_data("#voc_np_tot","m^{-3}",_("Total carriers (n+p)/2 at Voc"),["text"],"e",1.0))
lib.append(my_data("#voc_tau","s",_("Recombination time constant at Voc"),["text"],"e",1.0))
lib.append(my_data("#voc_R","m^{-3}s^{-1}",_("Recombination rate at Voc"),["text"],"e",1.0))
lib.append(my_data("#voc_J","A m^{-2}",_("Current density at Voc"),["text"],"e",1.0))
