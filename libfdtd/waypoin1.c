...
int pos=0;
 ...
 cl_int l_success = clGetPlatformInfo(platform,
  ...
  if( vendor )
  {
    l_success = clGetPlatformInfo(platform,
...
error=clSetKernelArg(k_rot13, 0, sizeof(ggEx), &ggEx);
printf("Set args\n");
...
//clSetKernelArg(k_rot13, 1, sizeof(ggEy), &ggEy);
//clSetKernelArg(k_rot13, 2, sizeof(ggEz), &ggEz);

//clSetKernelArg(k_rot13, 3, sizeof(ggHx), &ggHx);
//clSetKernelArg(k_rot13, 4, sizeof(ggHy), &ggHy);
//clSetKernelArg(k_rot13, 5, sizeof(ggHz), &ggHz);

//clSetKernelArg(k_rot13, 6, sizeof(ggEx_last), &ggEx_last);
//clSetKernelArg(k_rot13, 7, sizeof(ggEy_last), &ggEy_last);
//clSetKernelArg(k_rot13, 8, sizeof(ggEz_last), &ggEz_last);
...
//printf("%ld\n",i);
	...
	memcpy ( &gEx_last[i*ylen], Hx_last[i], sizeof(float)*ylen );
	memcpy ( &gEy_last[i*ylen], Hy_last[i], sizeof(float)*ylen );
	memcpy ( &gEz_last[i*ylen], Hz_last[i], sizeof(float)*ylen );

}

error=clEnqueueWriteBuffer(cq, ggEx, CL_FALSE, 0, (size_t)zlen*ylen*sizeof(float), gEx, 0, NULL, NULL);
//error=clEnqueueWriteBuffer(cq, mem1, CL_FALSE, 0, worksize, buf, 0, NULL, NULL);
if (error!=CL_SUCCESS)
{
           printf( "Error on buildProgram " );
...
//error=clEnqueueWriteBuffer(cq, ggEy, CL_FALSE, 0, zlen*ylen, gEy, 0, NULL, NULL);
//error=clEnqueueWriteBuffer(cq, ggEz, CL_FALSE, 0, zlen*ylen, gEz, 0, NULL, NULL);


//error=clEnqueueWriteBuffer(cq, ggHx, CL_FALSE, 0, zlen*ylen, gHx, 0, NULL, NULL);
//error=clEnqueueWriteBuffer(cq, ggHy, CL_FALSE, 0, zlen*ylen, gHy, 0, NULL, NULL);
//error=clEnqueueWriteBuffer(cq, ggHz, CL_FALSE, 0, zlen*ylen, gHz, 0, NULL, NULL);

//error=clEnqueueWriteBuffer(cq, ggEx_last, CL_FALSE, 0, zlen*ylen, gEx_last, 0, NULL, NULL);
//error=clEnqueueWriteBuffer(cq, ggEy_last, CL_FALSE, 0, zlen*ylen, gEy_last, 0, NULL, NULL);
//error=clEnqueueWriteBuffer(cq, ggEz_last, CL_FALSE, 0, zlen*ylen, gEz_last, 0, NULL, NULL);
size_t global;
global= (size_t)6;
printf("Running..\n");

error=clEnqueueNDRangeKernel(cq, k_rot13, 1, NULL, &global, &global, 0, NULL, NULL);
printf("Run\n");
error=clEnqueueReadBuffer(cq, ggEx, CL_FALSE, 0, zlen*ylen*sizeof(float), gEx, 0, NULL, NULL);
printf("Read\n");

//error=clEnqueueReadBuffer(cq, ggEy, CL_FALSE, 0, zlen*ylen, gEy, 0, NULL, NULL);
//error=clEnqueueReadBuffer(cq, ggEz, CL_FALSE, 0, zlen*ylen, gEz, 0, NULL, NULL);

//error=clEnqueueReadBuffer(cq, ggHx, CL_FALSE, 0, zlen*ylen, gHx, 0, NULL, NULL);
//error=clEnqueueReadBuffer(cq, ggHy, CL_FALSE, 0, zlen*ylen, gHy, 0, NULL, NULL);
//error=clEnqueueReadBuffer(cq, ggHz, CL_FALSE, 0, zlen*ylen, gHz, 0, NULL, NULL);

//error=clEnqueueReadBuffer(cq, ggEx_last, CL_FALSE, 0, zlen*ylen, gEx_last, 0, NULL, NULL);
//error=clEnqueueReadBuffer(cq, ggEy_last, CL_FALSE, 0, zlen*ylen, gEy_last, 0, NULL, NULL);
//error=clEnqueueReadBuffer(cq, ggEz_last, CL_FALSE, 0, zlen*ylen, gEz_last, 0, NULL, NULL);
	// Await completion of all the above
	error=clFinish(cq);
